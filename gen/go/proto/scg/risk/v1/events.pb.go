...
type RiskAlertNotification struct {
	...
	RiskDescription string                  `protobuf:"bytes,5,opt,name=risk_description,json=riskDescription,proto3" json:"risk_description,omitempty"`
...
const file_proto_scg_risk_v1_events_proto_rawDesc = "" +
	"\n" +
	"\x1eproto/scg/risk/v1/events.proto\x12\"proto.scg.notification.risk.events\x1a proto/scg/shared/v1/events.proto\x1a\x1fproto/scg/shared/v1/enums.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xbb\x03\n" +
	...
	"entityType\x12\x1b\n" +
	"\trisk_type\x18\x04 \x01(\tR\briskType\x12)\n" +
	"\x10risk_description\x18\x05 \x01(\tR\x0friskDescription\x12\x1d\n" +
	"\n" +
	"risk_score\x18\x06 \x01(\x01R\triskScore\x12\x1c\n" +
