...
type PartnerCreatedNotification struct {
	...
	PartnerLegalName    string                 `protobuf:"bytes,4,opt,name=partner_legal_name,json=partnerLegalName,proto3" json:"partner_legal_name,omitempty"`
	PartnerType         PartnerType            `protobuf:"varint,5,opt,name=partner_type,json=partnerType,proto3,enum=proto.scg.notification.partner.enums.PartnerType" json:"partner_type,omitempty"`
	...
	PrimaryContactEmail string                 `protobuf:"bytes,7,opt,name=primary_contact_email,json=primaryContactEmail,proto3" json:"primary_contact_email,omitempty"`
...
type PartnerVerificationStatusChangedNotification struct {
	...
	PartnerId       string                    `protobuf:"bytes,2,opt,name=partner_id,json=partnerId,proto3" json:"partner_id,omitempty"`
	PartnerName     string                    `protobuf:"bytes,3,opt,name=partner_name,json=partnerName,proto3" json:"partner_name,omitempty"`
	PreviousStatus  PartnerVerificationStatus `protobuf:"varint,4,opt,name=previous_status,json=previousStatus,proto3,enum=proto.scg.notification.partner.enums.PartnerVerificationStatus" json:"previous_status,omitempty"`
	NewStatus       PartnerVerificationStatus `protobuf:"varint,5,opt,name=new_status,json=newStatus,proto3,enum=proto.scg.notification.partner.enums.PartnerVerificationStatus" json:"new_status,omitempty"`
	VerifierId      string                    `protobuf:"bytes,6,opt,name=verifier_id,json=verifierId,proto3" json:"verifier_id,omitempty"`
	VerifierName    string                    `protobuf:"bytes,7,opt,name=verifier_name,json=verifierName,proto3" json:"verifier_name,omitempty"`
...
type PartnerAgreementCreatedNotification struct {
	...
	AgreementName  string                 `protobuf:"bytes,6,opt,name=agreement_name,json=agreementName,proto3" json:"agreement_name,omitempty"`
...
type PartnerAgreementSignedNotification struct {
	...
	AgreementType    string                 `protobuf:"bytes,5,opt,name=agreement_type,json=agreementType,proto3" json:"agreement_type,omitempty"`
	AgreementName    string                 `protobuf:"bytes,6,opt,name=agreement_name,json=agreementName,proto3" json:"agreement_name,omitempty"`
	SignedById       string                 `protobuf:"bytes,7,opt,name=signed_by_id,json=signedById,proto3" json:"signed_by_id,omitempty"`
	SignedByName     string                 `protobuf:"bytes,8,opt,name=signed_by_name,json=signedByName,proto3" json:"signed_by_name,omitempty"`
	SignedOnBehalfOf string                 `protobuf:"bytes,9,opt,name=signed_on_behalf_of,json=signedOnBehalfOf,proto3" json:"signed_on_behalf_of,omitempty"`
...
type PartnerAgreementExpiringNotification struct {
	...
	DaysUntilExpiration int32                  `protobuf:"varint,8,opt,name=days_until_expiration,json=daysUntilExpiration,proto3" json:"days_until_expiration,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
const file_proto_scg_partner_v1_events_proto_rawDesc = "" +
	"\n" +
	"!proto/scg/partner/v1/events.proto\x12%proto.scg.notification.partner.events\x1a proto/scg/shared/v1/events.proto\x1a proto/scg/partner/v1/enums.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x9c\x04\n" +
	...
	"\x12partner_legal_name\x18\x04 \x01(\tR\x10partnerLegalName\x12T\n" +
	"\fpartner_type\x18\x05 \x01(\x0e21.proto.scg.notification.partner.enums.PartnerTypeR\vpartnerType\x120\n" +
	"\x14primary_contact_name\x18\x06 \x01(\tR\x12primaryContactName\x122\n" +
	"\x15primary_contact_email\x18\a \x01(\tR\x13primaryContactEmail\x12\"\n" +
	"\rcreated_by_id\x18\b \x01(\tR\vcreatedById\x12&\n" +
	"\x0fcreated_by_name\x18\t \x01(\tR\rcreatedByName\x129\n" +
	"\n" +
	"created_at\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\"\xfd\x03\n" +
	...
	"\x11status_changed_at\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\x0fstatusChangedAt\"\xab\x04\n" +
	",PartnerVerificationStatusChangedNotification\x12K\n" +
	"\x04base\x18\x01 \x01(\v27.proto.scg.notification.shared.events.NotificationEventR\x04base\x12\x1d\n" +
	"\n" +
	"partner_id\x18\x02 \x01(\tR\tpartnerId\x12!\n" +
	"\fpartner_name\x18\x03 \x01(\tR\vpartnerName\x12h\n" +
	"\x0fprevious_status\x18\x04 \x01(\x0e2?.proto.scg.notification.partner.enums.PartnerVerificationStatusR\x0epreviousStatus\x12^\n" +
	"\n" +
	"new_status\x18\x05 \x01(\x0e2?.proto.scg.notification.partner.enums.PartnerVerificationStatusR\tnewStatus\x12\x1f\n" +
	"\vverifier_id\x18\x06 \x01(\tR\n" +
	"verifierId\x12#\n" +
	"\rverifier_name\x18\a \x01(\tR\fverifierName\x12\x14\n" +
	"\x05notes\x18\b \x01(\tR\x05notes\x12F\n" +
	"\x11status_changed_at\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\x0fstatusChangedAt\"\xb4\x04\n" +
	...
	"\fagreement_id\x18\x02 \x01(\tR\vagreementId\x12\x1d\n" +
	"\n" +
	"partner_id\x18\x03 \x01(\tR\tpartnerId\x12!\n" +
	"\fpartner_name\x18\x04 \x01(\tR\vpartnerName\x12%\n" +
	"\x0eagreement_type\x18\x05 \x01(\tR\ragreementType\x12%\n" +
	"\x0eagreement_name\x18\x06 \x01(\tR\ragreementName\x12A\n" +
	"\x0eeffective_date\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\reffectiveDate\x12C\n" +
	"\x0fexpiration_date\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\x0eexpirationDate\x12\"\n" +
	"\rcreated_by_id\x18\t \x01(\tR\vcreatedById\x12&\n" +
	"\x0fcreated_by_name\x18\n" +
	" \x01(\tR\rcreatedByName\x129\n" +
	"\n" +
	"created_at\x18\v \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\"\xd4\x03\n" +
	...
	"\fpartner_name\x18\x04 \x01(\tR\vpartnerName\x12%\n" +
	"\x0eagreement_type\x18\x05 \x01(\tR\ragreementType\x12%\n" +
	"\x0eagreement_name\x18\x06 \x01(\tR\ragreementName\x12 \n" +
	"\fsigned_by_id\x18\a \x01(\tR\n" +
	"signedById\x12$\n" +
	"\x0esigned_by_name\x18\b \x01(\tR\fsignedByName\x12-\n" +
	"\x13signed_on_behalf_of\x18\t \x01(\tR\x10signedOnBehalfOf\x127\n" +
	"\tsigned_at\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\bsignedAt\"\x9f\x03\n" +
	...
	"\fpartner_name\x18\x04 \x01(\tR\vpartnerName\x12%\n" +
	"\x0eagreement_type\x18\x05 \x01(\tR\ragreementType\x12%\n" +
	"\x0eagreement_name\x18\x06 \x01(\tR\ragreementName\x12C\n" +
	"\x0fexpiration_date\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x0eexpirationDate\x122\n" +
	"\x15days_until_expiration\x18\b \x01(\x05R\x13daysUntilExpirationBQZOgithub.com/hbttundar/scg-notification-contracts/gen/go/scg/partner/v1;partnerv1b\x06proto3"
