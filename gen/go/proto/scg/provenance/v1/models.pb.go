...
type ProvenanceRecord struct {
	...
	RecordType         ProvenanceRecordType         `protobuf:"varint,4,opt,name=record_type,json=recordType,proto3,enum=proto.scg.notification.provenance.enums.ProvenanceRecordType" json:"record_type,omitempty"`
	...
	VerificationMethod ProvenanceVerificationMethod `protobuf:"varint,14,opt,name=verification_method,json=verificationMethod,proto3,enum=proto.scg.notification.provenance.enums.ProvenanceVerificationMethod" json:"verification_method,omitempty"`
	VerifierId         string                       `protobuf:"bytes,15,opt,name=verifier_id,json=verifierId,proto3" json:"verifier_id,omitempty"`
	VerifierName       string                       `protobuf:"bytes,16,opt,name=verifier_name,json=verifierName,proto3" json:"verifier_name,omitempty"`
	...
	PreviousRecordId   string                       `protobuf:"bytes,21,opt,name=previous_record_id,json=previousRecordId,proto3" json:"previous_record_id,omitempty"`
	NextRecordId       string                       `protobuf:"bytes,22,opt,name=next_record_id,json=nextRecordId,proto3" json:"next_record_id,omitempty"`
...
type ProvenanceDispute struct {
	...
	DisputantId               string                  `protobuf:"bytes,5,opt,name=disputant_id,json=disputantId,proto3" json:"disputant_id,omitempty"`
	DisputantName             string                  `protobuf:"bytes,6,opt,name=disputant_name,json=disputantName,proto3" json:"disputant_name,omitempty"`
	DisputantOrganizationId   string                  `protobuf:"bytes,7,opt,name=disputant_organization_id,json=disputantOrganizationId,proto3" json:"disputant_organization_id,omitempty"`
	DisputantOrganizationName string                  `protobuf:"bytes,8,opt,name=disputant_organization_name,json=disputantOrganizationName,proto3" json:"disputant_organization_name,omitempty"`
	...
	EvidenceUrls              []string                `protobuf:"bytes,11,rep,name=evidence_urls,json=evidenceUrls,proto3" json:"evidence_urls,omitempty"`
	Status                    string                  `protobuf:"bytes,12,opt,name=status,proto3" json:"status,omitempty"`
	Resolution                string                  `protobuf:"bytes,13,opt,name=resolution,proto3" json:"resolution,omitempty"`
	ResolverId                string                  `protobuf:"bytes,14,opt,name=resolver_id,json=resolverId,proto3" json:"resolver_id,omitempty"`
	ResolverName              string                  `protobuf:"bytes,15,opt,name=resolver_name,json=resolverName,proto3" json:"resolver_name,omitempty"`
	DisputedAt                *timestamppb.Timestamp  `protobuf:"bytes,16,opt,name=disputed_at,json=disputedAt,proto3" json:"disputed_at,omitempty"`
...
type ProvenanceCertification struct {
	...
	CertificationName string                 `protobuf:"bytes,5,opt,name=certification_name,json=certificationName,proto3" json:"certification_name,omitempty"`
	...
	VerifierId        string                 `protobuf:"bytes,13,opt,name=verifier_id,json=verifierId,proto3" json:"verifier_id,omitempty"`
	VerifierName      string                 `protobuf:"bytes,14,opt,name=verifier_name,json=verifierName,proto3" json:"verifier_name,omitempty"`
...
const file_proto_scg_provenance_v1_models_proto_rawDesc = "" +
	"\n" +
	"$proto/scg/provenance/v1/models.proto\x12(proto.scg.notification.provenance.models\x1a#proto/scg/provenance/v1/enums.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xd4\t\n" +
	"\x10ProvenanceRecord\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1b\n" +
	"\tentity_id\x18\x02 \x01(\tR\bentityId\x12\x1f\n" +
	"\ventity_type\x18\x03 \x01(\tR\n" +
	"entityType\x12^\n" +
	"\vrecord_type\x18\x04 \x01(\x0e2=.proto.scg.notification.provenance.enums.ProvenanceRecordTypeR\n" +
	"recordType\x12W\n" +
	...
	"\revidence_urls\x18\r \x03(\tR\fevidenceUrls\x12v\n" +
	"\x13verification_method\x18\x0e \x01(\x0e2E.proto.scg.notification.provenance.enums.ProvenanceVerificationMethodR\x12verificationMethod\x12\x1f\n" +
	"\vverifier_id\x18\x0f \x01(\tR\n" +
	"verifierId\x12#\n" +
	"\rverifier_name\x18\x10 \x01(\tR\fverifierName\x12;\n" +
	...
	"recordedAt\x12,\n" +
	"\x12previous_record_id\x18\x15 \x01(\tR\x10previousRecordId\x12$\n" +
	"\x0enext_record_id\x18\x16 \x01(\tR\fnextRecordId\x12d\n" +
	...
	"entityType\x12\x1d\n" +
	"\n" +
	"record_ids\x18\x04 \x03(\tR\trecordIds\x12\x1f\n" +
	...
	"\x0flast_updated_at\x18\b \x01(\v2\x1a.google.protobuf.TimestampR\rlastUpdatedAt\x12c\n" +
	...
	"entityType\x12!\n" +
	"\fdisputant_id\x18\x05 \x01(\tR\vdisputantId\x12%\n" +
	"\x0edisputant_name\x18\x06 \x01(\tR\rdisputantName\x12:\n" +
	"\x19disputant_organization_id\x18\a \x01(\tR\x17disputantOrganizationId\x12>\n" +
	"\x1bdisputant_organization_name\x18\b \x01(\tR\x19disputantOrganizationName\x12X\n" +
	...
	"\revidence_urls\x18\v \x03(\tR\fevidenceUrls\x12\x16\n" +
	"\x06status\x18\f \x01(\tR\x06status\x12\x1e\n" +
	"\n" +
	"resolution\x18\r \x01(\tR\n" +
	"resolution\x12\x1f\n" +
	"\vresolver_id\x18\x0e \x01(\tR\n" +
	"resolverId\x12#\n" +
	"\rresolver_name\x18\x0f \x01(\tR\fresolverName\x12;\n" +
	"\vdisputed_at\x18\x10 \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"disputedAt\x12;\n" +
	...
	"\ventity_type\x18\x03 \x01(\tR\n" +
	"entityType\x12-\n" +
	"\x12certification_type\x18\x04 \x01(\tR\x11certificationType\x12-\n" +
	"\x12certification_name\x18\x05 \x01(\tR\x11certificationName\x12\x1b\n" +
	"\tissuer_id\x18\x06 \x01(\tR\bissuerId\x12\x1f\n" +
	"\vissuer_name\x18\a \x01(\tR\n" +
	"issuerName\x12'\n" +
	"\x0fcertificate_url\x18\b \x01(\tR\x0ecertificateUrl\x12%\n" +
	"\x0ecertificate_id\x18\t \x01(\tR\rcertificateId\x127\n" +
	"\tissued_at\x18\n" +
	...
	"isVerified\x12\x1f\n" +
	"\vverifier_id\x18\r \x01(\tR\n" +
	"verifierId\x12#\n" +
	"\rverifier_name\x18\x0e \x01(\tR\fverifierName\x12;\n" +
	...
	"\rMetadataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01BWZUgithub.com/hbttundar/scg-notification-contracts/gen/go/scg/provenance/v1;provenancev1b\x06proto3"
