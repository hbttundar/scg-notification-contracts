...
type NotificationEventEnvelope struct {
	...
	TraceUuid     string                 `protobuf:"bytes,4,opt,name=trace_uuid,json=traceUuid,proto3" json:"trace_uuid,omitempty"`
...
const file_proto_scg_shared_v1_events_proto_rawDesc = "" +
	"\n" +
	" proto/scg/shared/v1/events.proto\x12$proto.scg.notification.shared.events\x1a proto/scg/shared/v1/models.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfb\x01\n" +
	"\x19NotificationEventEnvelope\x12\x1d\n" +
	"\n" +
	"event_uuid\x18\x01 \x01(\tR\teventUuid\x12\x1d\n" +
	"\n" +
	"event_type\x18\x02 \x01(\tR\teventType\x12\x1d\n" +
	"\n" +
	"actor_uuid\x18\x03 \x01(\tR\tactorUuid\x12\x1d\n" +
	"\n" +
	"trace_uuid\x18\x04 \x01(\tR\ttraceUuid\x12;\n" +
